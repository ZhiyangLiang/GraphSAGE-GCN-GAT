...
def cora_train():
    ...
    features = nn.Parameter(torch.FloatTensor(feat_data),
                                   requires_grad=False)
    ...
    features = enc1(batch_nodes)
    agg2 = MeanAggregator(features=features)
    enc2 = Encoder(features=features, feature_dim=enc1.embed_dim, embed_dim=128,
